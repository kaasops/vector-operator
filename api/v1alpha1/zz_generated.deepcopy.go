...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentTemplates) DeepCopyInto(out *ComponentTemplates) {
	*out = *in
	if in.Sources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentTemplates.
func (in *ComponentTemplates) DeepCopy() *ComponentTemplates {
	if in == nil {
		return nil
	}
	out := new(ComponentTemplates)
	in.DeepCopyInto(out)
	return out
}
